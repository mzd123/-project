...
public class RolePowerSqlProvider {
    ...
    public String countByExample(RolePowerExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("TB_ROLE_POWER");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(RolePowerExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("TB_ROLE_POWER");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(RolePower record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(RolePowerExample example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("CM_ROLEID");
        sql.SELECT("CM_POWERID");
        sql.FROM("TB_ROLE_POWER");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        RolePower record = (RolePower) parameter.get("record");
    ...
    protected void applyWhere(SQL sql, RolePowerExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
